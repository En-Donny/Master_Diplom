...
class InferencePINNModel(mlflow.pyfunc.PythonModel):
    def __init__(self, model_path:str = None):
        ...
        state = torch.load(self.model_path, map_location=map_location, weights_only=True)
    ...
    def predict(self, context, model_input):
        ...
        prep_df = preprocess.preproc(model_input)
